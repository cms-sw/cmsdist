...
<runtime name="SHERPA_SHARE_PATH" value="$SHERPAMPI_BASE/share/SHERPA-MC"/>
<runtime name="SHERPA_INCLUDE_PATH" value="$SHERPAMPI_BASE/include/SHERPA-MC"/>
<runtime name="SHERPA_LIBRARY_PATH" value="$SHERPAMPI_BASE/lib/SHERPA-MC"/>
<use name="HepMC"/>
<use name="lhapdf"/>
<use name="blackhat"/>
</tool>

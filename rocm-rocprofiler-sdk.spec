...
%define cmake_args -DROCPROFILER_BUILD_TESTS=OFF -DROCPROFILER_BUILD_FMT=OFF -DROCPROFILER_BUILD_GHC_FS=OFF -DROCPROFILER_BUILD_GLOG=OFF -DROCPROFILER_BUILD_PYBIND11=OFF -DROCPROFILER_BUILD_SQLITE3=OFF -DCPACK_ENABLED=OFF -DCMAKE_CXX_FLAGS="-include fstream -include array -include memory -include unistd.h -include cstdint -I$ROCM_LLVM_ROOT/lib/llvm/include -I$ROCM_LLVM_ROOT/include -I$ROCM_COMGR_ROOT/include"

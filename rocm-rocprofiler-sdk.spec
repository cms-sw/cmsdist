...
cmake \
  ...
  -DCPACK_ENABLED=OFF \
  -DCMAKE_CXX_FLAGS="-include fstream -include array -include memory -include unistd.h -include cstdint -I$ROCM_LLVM_ROOT/lib/llvm/include -I$ROCM_LLVM_ROOT/include -I$COMGR_ROOT/include"

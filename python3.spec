...
echo "if 'PYTHONPATH' in environ:" >> %i/lib/python%{pythonv}/sitecustomize.py
echo "   import os,site" >> %i/lib/python%{pythonv}/sitecustomize.py
echo "   for p in environ['PYTHONPATH'].split(os.pathsep):">> %i/lib/python%{pythonv}/sitecustomize.py

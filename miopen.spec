...
Requires: hip rocm-core rocm-llvm rocm-cmake hsa-rocr rocm-info python3 rocm-roctracer sqlite hipblaslt hipblas rocblas rocrand bz2lib hipblas
Requires: json hipblas-common boost zstd
...
sed -i '842,845d' %{_builddir}/rocm-libraries-rocm-%{realversion}/projects/%{n}/CMakeLists.txt
cmake "${CMAKE_ARGS[@]}"

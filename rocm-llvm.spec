...
cmake -G Ninja \
  ...
  -DLLVM_EXTERNAL_DEVICE_LIBS_SOURCE_DIR=%{_builddir}/%{n}-%{realversion}/amd/device-libs \
  -DLLVM_EXTERNAL_COMGR_SOURCE_DIR=%{_builddir}/%{n}-%{realversion}/amd/comgr \
  -DLLVM_EXTERNAL_HIPCC_SOURCE_DIR=%{_builddir}/%{n}-%{realversion}/amd/hipcc \
  -DBUILD_TESTING=OFF \

...
Source0: svn://docutils.svn.sourceforge.net/svnroot/docutils/trunk/sandbox/rst2wiki@7467?scheme=http&strategy=export&module=sandbox&output=/rst2wiki.tar.gz

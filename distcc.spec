...
./configure \
  ...
  --without-gnome \
  --without-avahi \
  CFLAGS="-O2 -Wno-error=format-overflow -Wno-unused-but-set-variable -Wno-unused-local-typedefs -Wno-unused-parameter -Wno-unused-const-variable -Wno-error=stringop-truncation" \
  CC="$(which gcc)" \

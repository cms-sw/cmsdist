...
Patch2: patches/miopen-disable-clang-tidy
...
%define ROCMPostPrep patch -p2 -i %{PATCH0}; patch -p1 -i %{PATCH1}; patch -p1 -i %{PATCH2}; mkdir -p %{_builddir}/half-include/half; cp %{_sourcedir}/half.hpp %{_builddir}/half-include/half

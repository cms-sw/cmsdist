...
%define ROCMPreCMake sed -i '1,7d' plugin/perfetto/CMakeLists.txt ; sed -i 's/^set(ROCPROFILER_BUILD_TESTS ON)/set(ROCPROFILER_BUILD_TESTS OFF)/' CMakeLists.txt ; sed -i 's/^set(ROCPROFILER_BUILD_CI ON)/set(ROCPROFILER_BUILD_CI OFF)/' CMakeLists.txt

...
Source0: https://github.com/cms-sw/apt-rpm/archive/%{realversion}.tar.gz 
#git://github.com/cms-sw/apt-rpm.git?obj=master/%{realversion}&export=apt-rpm-%{realversion}&output=/apt-rpm-%{realversion}.tgz

...
Source0: %cvsserver&module=COMP/WEBTOOLS/Configuration&export=conf&tag=-rFRONTEND_CONF_3_9&output=/config.tar.gz
...
Obsoletes: cms+frontend+3.8-cmp
Obsoletes: cms+frontend+3.7-cmp
Obsoletes: cms+frontend+3.6-cmp
Obsoletes: cms+frontend+3.5-cmp
Obsoletes: cms+frontend+3.4b-cmp
Obsoletes: cms+frontend+3.4-cmp
Obsoletes: cms+frontend+3.3c-cmp
Obsoletes: cms+frontend+3.3b-cmp
Obsoletes: cms+frontend+3.3-cmp

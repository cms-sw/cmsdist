### RPM cms cmssw CMSSW_7_0_X_2013-07-26-2000
...
%define useCmsTC        yes
%define saveDeps        yes
%define branch          %(echo %realversion | sed -e's|\(CMSSW_[0-9][0-9]*_[0-9][0-9]*\).*|\1|g')
%define source1         git://github.com/cms-sw/cmssw.git?protocol=https&object=%{branch}/%{realversion}

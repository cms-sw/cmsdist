### RPM cms cmssw CMSSW_0_8_0_pre4-withlcg46
...
%define patchsrc2 rm -rf src/IOPool/TFileAdaptor src/Utilities/StorageFactory src/IOPool/AdaptorConfig src/Utilities/RFIOAdaptor src/Utilities/DCacheAdaptor

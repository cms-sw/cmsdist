...
# Change HEAD below to $realversion once it is tagged
Source1: git://github.com/dmwm/overview?obj=master/HEAD&export=%n&output=/%n.tar.gz
...
cd ../%n
export OVERVIEW_VERSION=%realversion
...
(echo ". %i/etc/profile.d/init.sh;"
 echo "export YUI3_ROOT D3_ROOT XREGEXP_ROOT OVERVIEW_ROOT OVERVIEW_VERSION;") > %i/etc/profile.d/env.sh

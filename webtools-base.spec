...
cmd="cmsWeb --base-url=$url --port $port --default-page /WSServer/ --log-file /data/project/base/base.log"
...
EOF
cat %i/bin/base_init | sed "s/--port/--ssl --port/g" > %i/bin/ssl_base_init

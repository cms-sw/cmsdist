### RPM external sherpa2-toolfile 1.0
Requires: sherpa2
%prep
...
cat << \EOF_TOOLFILE >%i/etc/scram.d/sherpa2.xml
<tool name="sherpa2" version="@TOOL_VERSION@">
...
<lib name="Zfunctions"/>
<client>
<environment name="SHERPA_BASE2" default="@TOOL_ROOT@"/>
<environment name="BINDIR" default="$SHERPA_BASE2/bin"/>
<environment name="LIBDIR" default="$SHERPA_BASE2/lib/SHERPA-MC"/>
<environment name="INCLUDE" default="$SHERPA_BASE2/include/SHERPA-MC"/>
</client>
<runtime name="CMSSW_FWLITE_INCLUDE_PATH" value="$SHERPA_BASE2/include" type="path"/>
<runtime name="SHERPA_SHARE_PATH" value="$SHERPA_BASE2/share/SHERPA-MC" type="path"/>
<runtime name="SHERPA_INCLUDE_PATH" value="$SHERPA_BASE2/include/SHERPA-MC" type="path"/>
<use name="HepMC"/>
<use name="lhapdf"/>
<use name="qd"/>
<use name="blackhat"/>

### RPM cms reqmgr2 1.1.3_cmsweb.patch1
...
Requires: py2-sqlalchemy py2-httplib2 cherrypy py2-cheetah rotatelogs couchdb py2-sphinx py2-pycurl dbs3-client
Requires: py2-future py2-retry
Requires: jemalloc

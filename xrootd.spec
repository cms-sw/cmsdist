...
case %cmsos in
  slc*_amd64*)
    ./configure.classic x86_64_linux_26 --ccflavour=gccx8664  --enable-krb5 $CONFIG_ARGS --with-krb5=/usr ;;
  slc*_ia32*)
    ./configure.classic i386_linux26 --ccflavour=gcc --enable-krb5 $CONFIG_ARGS --with-krb5=/usr ;;
  *)

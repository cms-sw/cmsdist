...
echo export LIFECYCLE=$PHEDEX_LIFECYCLE_ROOT/Testbed/LifeCycle >> %i/etc/profile.d/dependencies-setup.sh
echo setenv LIFECYCLE $PHEDEX_LIFECYCLE_ROOT/Testbed/LifeCycle >> %i/etc/profile.d/dependencies-setup.csh

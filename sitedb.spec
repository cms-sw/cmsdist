...
%define svnsrc svn://svn.cern.ch/reps/CMSDMWM/SiteDB/tags/2.1.0
...
Requires: cherrypy yui yui3 d3 yuicompressor py2-cx-oracle py2-cjson rotatelogs py2-sphinx

### RPM external oracle 10.2.0.4.0
## INITENV SET ORACLE_HOME %i
# ## BUILDIF case $(uname):$(uname -p) in Linux:i*86 ) true ;; Linux:x86_64 ) true ;;  Linux:ppc64 ) false ;; Darwin:* ) false ;; * ) false ;; esac

Source0: http://cmsrep.cern.ch/cmssw/oracle-mirror/%cmsos/%realversion/instantclient-basic-macosx-10.2.0.4.0.zip
Source1: http://cmsrep.cern.ch/cmssw/oracle-mirror/%cmsos/%realversion/instantclient-sdk-macosx-10.2.0.4.0.zip
Source2: http://cmsrep.cern.ch/cmssw/oracle-mirror/%cmsos/%realversion/instantclient-sqlplus-macosx-10.2.0.4.0.zip
...
unzip -o -u %_sourcedir/instantclient-basic-macosx-10.2.0.4.0.zip
unzip -o -u %_sourcedir/instantclient-sdk-macosx-10.2.0.4.0.zip
unzip -o -u %_sourcedir/instantclient-sqlplus-macosx-10.2.0.4.0.zip

### RPM cms dasgoclient-binary v01.00.03
...
Source6: git+https://github.com/dmwm/das2go?obj=master/f7d9e9d71d1e0db6c981ecbaf2d1a1d327ccdbfc&export=github.com/dmwm/das2go&output=/das2go.tar.gz
%prep

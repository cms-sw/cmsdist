### RPM cms dasgoclient-binary v00.00.09
...
Source6: git+https://github.com/vkuznet/das2go?obj=master/08d33886276836fa977d474b68d2abf2ba9da7ab&export=github.com/vkuznet/das2go&output=/das2go.tar.gz
%prep
